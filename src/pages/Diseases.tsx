...
const DEFAULT_DISEASES: Disease[] = [
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1532451372562-b9e07fb293c0?w=600&auto=format&fit=crop&q=80',
    season: 'Kharif',
    created_at: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1628172908865-c70e28f28ab5?w=600&auto=format&fit=crop&q=80',
    season: 'Kharif',
    created_at: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1598112972019-91e1162b80f7?w=600&auto=format&fit=crop&q=80',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1518977956812-cd3dbadaaf31?w=600&auto=format&fit=crop&q=80',
    season: 'Rabi',
    created_at: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1567306301408-9b74779a11af?w=600&auto=format&fit=crop&q=80',
    season: 'Kharif',
    created_at: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1591073113125-e46713c829ed?w=600&auto=format&fit=crop&q=80',
    season: 'Rabi',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1627308595229-7830a5c18037?w=600&auto=format&fit=crop&q=80',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
