...
const DEFAULT_DISEASES: Disease[] = [
  ...
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Yellow_curl_leaf_disease_Pj_IMG_3162.jpg/600px-Yellow_curl_leaf_disease_Pj_IMG_3162.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Pectinophora_gossypiella_1265079.jpg/600px-Pectinophora_gossypiella_1265079.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'Kharif',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1563604859-b1d5c22501a3?w=600&auto=format&fit=crop&q=80',
    season: 'Rabi',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1629851609139-47021ebcf88a?w=600&auto=format&fit=crop&q=80',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Spodoptera_frugiperda.jpg/600px-Spodoptera_frugiperda.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'Kharif',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Chain_of_conidia_of_an_Alternaria_sp._fungus_PHIL_3963_lores.jpg/600px-Chain_of_conidia_of_an_Alternaria_sp._fungus_PHIL_3963_lores.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'Rabi',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=600&auto=format&fit=crop&q=80',
    season: 'Kharif',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1605330372863-95fae2f494f6?w=600&auto=format&fit=crop&q=80',
    season: 'Kharif',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/K7725-1-sm.jpg/600px-K7725-1-sm.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1592079927431-3f8cdf0aa42a?w=600&auto=format&fit=crop&q=80',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Golovinomyces_sordidus_on_Broadleaf_Plantain_-_Plantago_major_%2844171864324%29.jpg/600px-Golovinomyces_sordidus_on_Broadleaf_Plantain_-_Plantago_major_%2844171864324%29.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'Rabi',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Transverse_ladybird_%28Coccinella_transversalis%29.jpg/600px-Transverse_ladybird_%28Coccinella_transversalis%29.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'Rabi',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Cocos_nucifera_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-187.jpg/600px-Cocos_nucifera_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-187.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Leucinodes_orbonalis.jpg/600px-Leucinodes_orbonalis.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Late_blight_on_potato_leaf_2.jpg/600px-Late_blight_on_potato_leaf_2.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'Rabi',
    created_at: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Falscher_Mehltau.jpg/600px-Falscher_Mehltau.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Alternaria_solani_-_leaf_lesions.jpg/600px-Alternaria_solani_-_leaf_lesions.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'All Season',
    created_at: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Nilaparvata_lugens_439632934.jpg/600px-Nilaparvata_lugens_439632934.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail',
    season: 'Kharif',
    created_at: new Date().toISOString(),
  },
];
