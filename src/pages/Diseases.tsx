...
const DEFAULT_DISEASES: Disease[] = [
  ...
  },
  {
    ...
    image_url: '/images/diseases/mango_powdery_mildew_greenlife.jpg',
    images: [
      '/images/diseases/mango_powdery_mildew_greenlife.jpg',
      '/images/diseases/mango_powdery_mildew.jpg'
    ],
    season: 'Rabi',
    created_at: new Date().toISOString(),
  },
  ...
  },
  {
    id: 'd25',
    crop_name: 'Lettuce',
    disease_name: 'Pythium Wilt & Root Rot (Pythium uncinulatum)',
    symptoms: 'Sudden wilting during warm daytime temperatures, stunted plant growth, brown water-soaked rotting of feeder and tap roots.',
    causes: 'Oomycete pathogen Pythium uncinulatum / Pythium spp. favored by excessive soil moisture, poorly drained soils, and warm temperatures.',
    prevention: 'Improve field drainage, avoid over-irrigation, practice crop rotation, use raised beds and clean pathogen-free seedlings.',
    treatment: 'Soil drenching with Mefenoxam / Metalaxyl 35% WS @ 1.5g/litre or Propamocarb hydrochloride 72.2% SL @ 2ml/litre.',
    organic_solution: 'Incorporate Trichoderma harzianum or Bacillus subtilis biofungicides into soil before planting; apply compost tea to promote beneficial root microbes.',
    image_url: '/images/diseases/lettuce_pythium_wilt.jpg',
    season: 'Rabi',
    created_at: new Date().toISOString(),
  },
];
