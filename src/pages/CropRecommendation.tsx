...
const DEFAULT_CROPS: Crop[] = [
  { id: 'c1', crop_name: 'Paddy', scientific_name: 'Oryza sativa', soil_type: 'Clayey / Loamy', suitable_season: 'Kharif', water_requirement: 'High (1200-1500 mm)', temperature_range: '22-32°C', rainfall_range: '1000-1500 mm', fertilizer: 'Urea: 50kg, DAP: 50kg, MOP: 25kg', growth_duration: '120-140 days', expected_yield: '4-5 tons/acre', market_value: 'High', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Pana_Banaue_Rice_Terraces_%28Cropped%29.jpg/600px-Pana_Banaue_Rice_Terraces_%28Cropped%29.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
