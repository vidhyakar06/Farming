...
const DEFAULT_CROPS: Crop[] = [
  { id: 'c1', crop_name: 'Paddy', scientific_name: 'Oryza sativa', soil_type: 'Clayey / Loamy', suitable_season: 'Kharif', water_requirement: 'High (1200-1500 mm)', temperature_range: '22-32°C', rainfall_range: '1000-1500 mm', fertilizer: 'Urea: 50kg, DAP: 50kg, MOP: 25kg', growth_duration: '120-140 days', expected_yield: '4-5 tons/acre', market_value: 'High', image_url: 'https://images.unsplash.com/photo-1536657464919-892534f60d6e?w=600&auto=format&fit=crop&q=80' },
