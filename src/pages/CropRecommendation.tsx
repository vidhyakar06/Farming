...
const DEFAULT_CROPS: Crop[] = [
  { id: 'c1', crop_name: 'Paddy', scientific_name: 'Oryza sativa', soil_type: 'Clayey / Loamy', suitable_season: 'Kharif', water_requirement: 'High (1200-1500 mm)', temperature_range: '22-32°C', rainfall_range: '1000-1500 mm', fertilizer: 'Urea: 50kg, DAP: 50kg, MOP: 25kg', growth_duration: '120-140 days', expected_yield: '4-5 tons/acre', market_value: 'High', image_url: 'https://cdn.pixabay.com/photo/2022/06/29/06/41/paddy-crops-7291074_640.jpg' },
