...
const BUILTIN_CROPS: GalleryItem[] = [
  { id: 'g-paddy', name: 'Paddy (Rice)', subtitle: 'Oryza sativa', tag: 'Cereal', season: 'Kharif', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20healthy%20Paddy%20Rice%20growing%20in%20a%20lush%20green%20flooded%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-wheat', name: 'Wheat', subtitle: 'Triticum aestivum', tag: 'Cereal', season: 'Rabi', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20golden%20Wheat%20ready%20for%20harvest%20in%20a%20sunlit%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-tomato', name: 'Tomato', subtitle: 'Solanum lycopersicum', tag: 'Vegetable', season: 'All Season', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20ripe%20red%20Tomatoes%20growing%20on%20a%20vine%20in%20a%20garden%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-cotton', name: 'Cotton', subtitle: 'Gossypium hirsutum', tag: 'Cash Crop', season: 'Kharif', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20blooming%20Cotton%20plants%20in%20a%20sunny%20agricultural%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-sugarcane', name: 'Sugarcane', subtitle: 'Saccharum officinarum', tag: 'Cash Crop', season: 'All Season', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20tall%20Sugarcane%20plants%20in%20a%20vibrant%20farm%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-maize', name: 'Maize (Corn)', subtitle: 'Zea mays', tag: 'Cereal', season: 'Kharif', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20healthy%20green%20Maize%20Corn%20growing%20in%20a%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-onion', name: 'Onion', subtitle: 'Allium cepa', tag: 'Vegetable', season: 'Rabi', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20fresh%20Onions%20with%20green%20stalks%20in%20the%20soil%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-chilli', name: 'Chilli', subtitle: 'Capsicum annuum', tag: 'Spice', season: 'Kharif', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20bright%20red%20Chilli%20peppers%20growing%20on%20a%20plant%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-banana', name: 'Banana', subtitle: 'Musa acuminata', tag: 'Fruit', season: 'All Season', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20a%20bunch%20of%20green%20Bananas%20hanging%20from%20a%20tree%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-mango', name: 'Mango', subtitle: 'Mangifera indica', tag: 'Fruit', season: 'Summer', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20fresh%20ripe%20Mangoes%20hanging%20from%20a%20leafy%20tree%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-coconut', name: 'Coconut', subtitle: 'Cocos nucifera', tag: 'Plantation', season: 'All Season', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20a%20tall%20Coconut%20palm%20tree%20with%20coconuts%20against%20a%20blue%20sky%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-soybean', name: 'Soybean', subtitle: 'Glycine max', tag: 'Oilseed', season: 'Kharif', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20healthy%20Soybean%20plants%20with%20pods%20in%20a%20green%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-potato', name: 'Potato', subtitle: 'Solanum tuberosum', tag: 'Vegetable', season: 'Rabi', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20Potatoes%20growing%20in%20soil%20on%20a%20farm%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-groundnut', name: 'Groundnut', subtitle: 'Arachis hypogaea', tag: 'Oilseed', season: 'Kharif', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20Groundnut%20peanut%20plants%20growing%20in%20a%20farm%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-brinjal', name: 'Brinjal (Eggplant)', subtitle: 'Solanum melongena', tag: 'Vegetable', season: 'All Season', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20purple%20Brinjal%20Eggplant%20growing%20on%20a%20plant%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-turmeric', name: 'Turmeric', subtitle: 'Curcuma longa', tag: 'Spice', season: 'Kharif', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20fresh%20Turmeric%20plant%20leaves%20in%20an%20agricultural%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-ginger', name: 'Ginger', subtitle: 'Zingiber officinale', tag: 'Spice', season: 'Kharif', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20Ginger%20plant%20with%20green%20leaves%20growing%20in%20soil%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-garlic', name: 'Garlic', subtitle: 'Allium sativum', tag: 'Spice', season: 'Rabi', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20Garlic%20plants%20growing%20in%20a%20farm%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-mustard', name: 'Mustard', subtitle: 'Brassica juncea', tag: 'Oilseed', season: 'Rabi', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20bright%20yellow%20blooming%20Mustard%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-cucumber', name: 'Cucumber', subtitle: 'Cucumis sativus', tag: 'Vegetable', season: 'All Season', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20fresh%20green%20Cucumbers%20growing%20on%20a%20vine%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-papaya', name: 'Papaya', subtitle: 'Carica papaya', tag: 'Fruit', season: 'All Season', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20a%20Papaya%20tree%20loaded%20with%20green%20and%20orange%20fruits%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
  { id: 'g-watermelon', name: 'Watermelon', subtitle: 'Citrullus lanatus', tag: 'Fruit', season: 'Summer', type: 'crop', image_url: 'https://image.pollinations.ai/prompt/Realistic%20photo%20of%20a%20large%20green%20Watermelon%20growing%20in%20a%20sunny%20field%20high%20quality%20agriculture%20photography?width=600&height=400&nologo=true' },
];
