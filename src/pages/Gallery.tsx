...
const BUILTIN_CROPS: GalleryItem[] = [
  { id: 'g-paddy', name: 'Paddy (Rice)', subtitle: 'Oryza sativa', tag: 'Cereal', season: 'Kharif', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Mature_Rice_%28India%29_by_Augustus_Binu.jpg/600px-Mature_Rice_%28India%29_by_Augustus_Binu.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-wheat', name: 'Wheat', subtitle: 'Triticum aestivum', tag: 'Cereal', season: 'Rabi', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Bl%C3%A9_tendre_%28GRAPELLI%29_AO-5-cliche_Jean_Weber_%285%29_%2823975019962%29.jpg/600px-Bl%C3%A9_tendre_%28GRAPELLI%29_AO-5-cliche_Jean_Weber_%285%29_%2823975019962%29.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-tomato', name: 'Tomato', subtitle: 'Solanum lycopersicum', tag: 'Vegetable', season: 'All Season', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Tomato_je.jpg/600px-Tomato_je.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-cotton', name: 'Cotton', subtitle: 'Gossypium hirsutum', tag: 'Cash Crop', season: 'Kharif', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/CottonPlant.JPG/600px-CottonPlant.JPG?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-sugarcane', name: 'Sugarcane', subtitle: 'Saccharum officinarum', tag: 'Cash Crop', season: 'All Season', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Saccharum_officinarum%2C_Mozambique.jpg/600px-Saccharum_officinarum%2C_Mozambique.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-maize', name: 'Maize (Corn)', subtitle: 'Zea mays', tag: 'Cereal', season: 'Kharif', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Zea_mays_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-283.jpg/600px-Zea_mays_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-283.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-onion', name: 'Onion', subtitle: 'Allium cepa', tag: 'Vegetable', season: 'Rabi', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Mixed_onions.jpg/600px-Mixed_onions.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-chilli', name: 'Chilli', subtitle: 'Capsicum annuum', tag: 'Spice', season: 'Kharif', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Capsicum_annuum_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-027.jpg/600px-Capsicum_annuum_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-027.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-banana', name: 'Banana', subtitle: 'Musa acuminata', tag: 'Fruit', season: 'All Season', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Musa_acuminata_in_india01.jpg/600px-Musa_acuminata_in_india01.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-mango', name: 'Mango', subtitle: 'Mangifera indica', tag: 'Fruit', season: 'Summer', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Mangoes_%28Magnifera_indica%29_from_India.jpg/600px-Mangoes_%28Magnifera_indica%29_from_India.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-coconut', name: 'Coconut', subtitle: 'Cocos nucifera', tag: 'Plantation', season: 'All Season', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Cocos_nucifera_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-187.jpg/600px-Cocos_nucifera_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-187.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-soybean', name: 'Soybean', subtitle: 'Glycine max', tag: 'Oilseed', season: 'Kharif', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Soybean.USDA.jpg/600px-Soybean.USDA.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-potato', name: 'Potato', subtitle: 'Solanum tuberosum', tag: 'Vegetable', season: 'Rabi', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Patates.jpg/600px-Patates.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-groundnut', name: 'Groundnut', subtitle: 'Arachis hypogaea', tag: 'Oilseed', season: 'Kharif', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Arachis_hypogaea_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-163.jpg/600px-Arachis_hypogaea_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-163.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-brinjal', name: 'Brinjal (Eggplant)', subtitle: 'Solanum melongena', tag: 'Vegetable', season: 'All Season', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Solanum_melongena_24_08_2012_%281%29.JPG/600px-Solanum_melongena_24_08_2012_%281%29.JPG?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-turmeric', name: 'Turmeric', subtitle: 'Curcuma longa', tag: 'Spice', season: 'Kharif', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Turmeric_inflorescence.jpg/600px-Turmeric_inflorescence.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-ginger', name: 'Ginger', subtitle: 'Zingiber officinale', tag: 'Spice', season: 'Kharif', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Koeh-146-no_text.jpg/600px-Koeh-146-no_text.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-garlic', name: 'Garlic', subtitle: 'Allium sativum', tag: 'Spice', season: 'Rabi', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/3/39/Allium_sativum_Woodwill_1793.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail_unscaled' },
  { id: 'g-mustard', name: 'Mustard', subtitle: 'Brassica juncea', tag: 'Oilseed', season: 'Rabi', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Brassica_juncea_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-168.jpg/600px-Brassica_juncea_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-168.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-cucumber', name: 'Cucumber', subtitle: 'Cucumis sativus', tag: 'Vegetable', season: 'All Season', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/ARS_cucumber.jpg/600px-ARS_cucumber.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-papaya', name: 'Papaya', subtitle: 'Carica papaya', tag: 'Fruit', season: 'All Season', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Carica_papaya_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-029.jpg/600px-Carica_papaya_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-029.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
  { id: 'g-watermelon', name: 'Watermelon', subtitle: 'Citrullus lanatus', tag: 'Fruit', season: 'Summer', type: 'crop', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/Taiwan_2009_Tainan_City_Organic_Farm_Watermelon_FRD_7962.jpg/600px-Taiwan_2009_Tainan_City_Organic_Farm_Watermelon_FRD_7962.jpg?utm_source=en.wikipedia.org&utm_campaign=api&utm_content=thumbnail' },
];
