        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg font-semibold text-slate-800 dark:text-white">{t('settings.display')}</h3>
            </div>
            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-700/50">
              <div>
                <p className="font-medium text-slate-700 dark:text-slate-200">{t('settings.mode')}</p>
                <p className="text-sm text-slate-500 dark:text-slate-400">{t('settings.modeDesc')}</p>
              </div>
              <button
                onClick={toggleTheme}
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-800 dark:text-white">{t('settings.language')}</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">{t('settings.selectLanguage')}</p>
              </div>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg font-semibold text-slate-800 dark:text-white">{t('settings.notifications')}</h3>
            </div>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-700/50">
                <div>
                  <p className="font-medium text-slate-700 dark:text-slate-200">{t('settings.pushNotif')}</p>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-700/50">
                <div>
                  <p className="font-medium text-slate-700 dark:text-slate-200 flex items-center gap-2">
                    <Mail className="w-4 h-4" /> {t('settings.emailNotif')}
                  </p>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg font-semibold text-slate-800 dark:text-white">{t('settings.security')}</h3>
            </div>
